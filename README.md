...
A structured learning journal documenting my progress through the **IBM RAG and Agentic AI Professional Certificate** — from Generative AI foundations to building production-ready AI applications with LangChain and Flask.
...
> Core theory behind how LLMs work and how to communicate with them effectively.
...
> Building blocks for creating structured, multi-step AI workflows.
...
> Applying GenAI concepts to build and deploy a real web application.
